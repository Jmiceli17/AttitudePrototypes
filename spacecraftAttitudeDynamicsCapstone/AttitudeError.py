...
if __name__ == "__main__":
    ...
    # Sun pointing
    dcm_Rs_N = ReferenceAttitudes.GetSunPointingReferenceAttitude(t)
    N_omega_RsN = ReferenceAttitudes.GetSunPointingReferenceAngularVelocity(t)
    ...
    # Nadir pointing
    dcm_Rn_N = ReferenceAttitudes.GetNadirPointingReferenceAttitude(t)
    N_omega_RnN = ReferenceAttitudes.GetNadirPointingReferenceAngularVelocity(t)
    ...
    # GMO Pointing
    dcm_Rg_N = ReferenceAttitudes.GetGmoPointingReferenceAttitude(t)
    N_omega_RgN = ReferenceAttitudes.GetGmoPointingReferenceAngularVelocity(t)
